        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li style="display: none;"><a href="#tab_3" data-toggle="tab">Footer & Contact</a></li>
                        <li style="display: none;"><a href="#tab_4" data-toggle="tab">Message Settings</a></li>
                        <li style="display: none;"><a href="#tab_5" data-toggle="tab">Products</a></li>
                        <li style="display: none;"><a href="#tab_6" data-toggle="tab">Home Settings</a></li>
                        <li style="display: none;"><a href="#tab_7" data-toggle="tab">Banner Settings</a></li>
                        <li style="display: none;"><a href="#tab_9" data-toggle="tab">Payment Settings</a></li>
                        <li style="display: none;"><a href="#tab_10" data-toggle="tab">Head & Body Scripts</a></li>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1"><?=UPDATE_LOGO?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2"><?=UPDATE_FAVICON?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
